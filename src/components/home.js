  ...
  const {state, dispatch} = userStateService
    ...
    <div className=' flex flex-col min-h-screen'>
      ...
      <div className="h-screen bg-gray-200 relative ">
        <AnimatedBackground/>
        <h1 className="text-center text-4xl font-bold tracking-tight text-white sm:text-6xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
      ...
      <div>
        <div className="grid grid-cols-0 lg:grid-cols-2 ">
          {features.map((feature,index) => (
            <div className='flex m-0 sm:m-16 lg:m-20' key={index} >
